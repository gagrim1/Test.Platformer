...
**Player(Test)** - зачем? Понятно, что точка респавна, но это должна быть просто пустышка с **Transform**, а к ней там вообще все скрипты игрока прикреплены - какая-то невидимая копия игрока получается.
